...
namespace StoreHouse.Controllers
{
    ...
    public class PartnersController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("PartnerID,name,description,email,phone")] Partner partner)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("PartnerID,name,description,email,phone")] Partner partner)
        {
